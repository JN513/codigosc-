        ...
        if self.tamanho >= -1:
            for elem in range(0, self.tamanho + 1):
                if str(placa.upper()) == str(self.placa[elem]):
                    ...
                    print(
                        "Não foi encontrada nenhuma placa '"
                        + str(placa)
            ...
            print(
                "A tabela está vazia portanto nao é possivel encontrar a placa desejada."
            )
    ...
    def inserir(self, placa, valor):
        if self.tamanho >= -1:
            if self.tamanho + 1 < self.tamanhomax:
                ...
                print(
                    "Nao tem mais espaço para a inserção de novos cadastros, voce deve excluir algum ou iniciar uma nova tabela."
                )
        else:
            print("Nao existe tabela, é necessario criar uma.")
